import 'package:equatable/equatable.dart';import 'package:flutter/material.dart';import '/core/app_export.dart';import '../models/gridplay2_item_model.dart';import 'package:bollyflow/presentation/trending_hashtag_details_screen/models/trending_hashtag_details_model.dart';part 'trending_hashtag_details_event.dart';part 'trending_hashtag_details_state.dart';class TrendingHashtagDetailsBloc extends Bloc<TrendingHashtagDetailsEvent, TrendingHashtagDetailsState> {TrendingHashtagDetailsBloc(TrendingHashtagDetailsState initialState) : super(initialState) { on<TrendingHashtagDetailsInitialEvent>(_onInitialize); }
